...
public class Main {
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(filePersistent.write("Bianca;Bia@gmail.com;10/12/2004"));
        System.out.println("========================");
        ...
        System.out.println("========================");
        System.out.println(filePersistent.remove("Bia@gmail.com"));
        System.out.println("========================");
        System.out.println(filePersistent.findBy("Laura@"));
        System.out.println("========================");
